  ...
  return (
    <div className="min-h-screen  bg-gray-700 from-blue-50 to-white p-4 md:p-8">
      <div className="max-w-3xl mt-24 mx-auto pt-8 md:pt-16">
        <h1 className="text-4xl md:text-5xl font-bold text-center mb-2 text-white">NexusEarth</h1>
        <p className="text-white text-center mb-8">Encontre o que você está procurando</p>
